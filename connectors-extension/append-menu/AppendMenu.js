...
import '../change-menu/ChangeMenu.css';
...
function AppendMenuComponent(props) {
  ...
  return html`
    <div class="cmd-change-menu">
      <div class="cmd-change-menu__backdrop" onClick=${ onCancel }></div>
      <div class="cmd-change-menu__overlay" style=${ `top: ${props.position.x}px; left: ${props.position.y }px` }>
